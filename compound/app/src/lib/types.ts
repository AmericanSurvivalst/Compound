export type CompoundCategory = 'peptide' | 'sarm' | 'nootropic' | 'hormone' | 'support' | 'pct';
export type ResearchLevel = 'well-researched' | 'moderate' | 'experimental';
export type SuppressionLevel = 'none' | 'mild' | 'significant';
...
export const researchInfo: Record<ResearchLevel, { label: string; color: string }> = {
  ...
  'experimental': { label: 'Experimental', color: 'research-experimental' },
};
